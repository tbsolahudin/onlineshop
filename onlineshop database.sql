...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Des 2024 pada 06.56
...
--
-- Struktur dari tabel `detail_order_product`
--
...
--
-- Dumping data untuk tabel `detail_order_product`
--
...
(108, '6l3m2fbunjumn9gkh84lg8dds4', '', 4, 'andy', 'tbsolahudint@gmail.com', '42262', 'ewqeqw', 0, 262, 7, '', '598500', 'New', '2024-12-05', '', 'N'),
(109, 'm6u8v8r0gm4o58opu7c8m6rd80', '', 4, 'andy', 'sehangatrasa@gmail.com', '42262', 'ewqeqw', 0, 5, 0, '', '0', 'New', '2024-12-11', '', 'N');
...
(52, 'spring shirt', 10, 3, -3, 2, 2, 100000, '1484453822_s1.jpg', '1484450935_s2.jpg|1484450935_s3.jpg|1484450935_s4.jpg', 18, 'barang bagus mulus halus nyaman'),
...
(10, 52, 4, 'cantik', 5, 'kreatif bnget', 'N', '2024-12-05', '13:59:04');
...
--
-- Dumping data untuk tabel `slidshow`
--
...
(1, 'admin', 'admin ganteng', '21232f297a57a5a743894a0e4a801fc3', 'admins@gmail.com', 'admin'),
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=442;
...
--
-- AUTO_INCREMENT untuk tabel `slidshow`
--
ALTER TABLE `slidshow`
