...
<div id="footer">
  <div class="container">
    <p class="footer-class">hijab muslimah ; <?php echo date('Y') ?> | ig @HijabMuslim | email: <a href="https://stokcoding.com/" title="hijabmuslimah@gmail.com" target="_blank">HijabMuslim@gmail.com</a></p>
  </div>
</div>
</div>
